                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control input-required" name="name" value="{{ old('name', $permission->name) }}" autocomplete="name">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="key" type="text" class="form-control input-required" name="key" value="{{ old('key', $permission->key) }}" autocomplete="key">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="table" type="text" class="form-control" name="table" value="{{ old('table', $permission->table) }}" autocomplete="table">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="description" class="form-control" rows="4" name="description">{{ old('description', $permission->description) }}</textarea>
                            </div>
                        </div>
                    </div>
