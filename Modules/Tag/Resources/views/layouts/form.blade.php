                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-required" name="name" value="{{ old('name', $tag->name) }}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" name="description">{{ old('description', $tag->description) }}</textarea>
                            </div>
                        </div>
                    </div>
