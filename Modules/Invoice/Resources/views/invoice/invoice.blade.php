            ...
            <div class="box-body">
                <div class="row text-4">
                    ...
                    <div class="col-lg-3">
                        ...
                        <p class="px-2"><strong>Payment Method:</strong> {{ PaymentMethod::getName($invoice->payment_method) }}</p>
                    </div>
                </div>
                ...
                <div class="row mt-4 text-4 order-invoice-footer">
                    <div class="col-lg-4">
                        ...
                        <textarea name="note" id="note" class="form-control full-width note-box">{{ $invoice->note }}</textarea>
                    </div>
