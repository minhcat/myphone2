        ...
        <div class="box box-primary box-main">
            ...
            <div class="box-body">
                        ...
                        <tbody class="tbody-data hidden">
                            @foreach ($gifts as $key => $gift)
                                <tr>
                                    ...
                                    @if ($gift->user)
                                    @can('user:read')
                                    <td><a href="{{ route('admin.user.show', $gift->user->id) }}">{{ $gift->user->account }}</a></td>
                                    @else
                                    <td>{{ $gift->user->account }}</td>
                                    @endcan
                                    @else
                                    <td></td>
                                    @endif
                ...
                <div class="table-footer mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ $gifts->appends($_GET)->links(get_admin_theme_extend($admin_active_theme, 'paginate')) }}
                        </div>
                    </div>
                </div>
            </div>
