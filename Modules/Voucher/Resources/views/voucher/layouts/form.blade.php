@php
    $voucher = isset($voucher) ? $voucher : new Modules\Voucher\Entities\Voucher;
@endphp
<div class="row">
    <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control" name="name" value="{{ $voucher->name }}" autocomplete="name">
                            </div>
                        </div>
                    </div>
                    <div class="row">
