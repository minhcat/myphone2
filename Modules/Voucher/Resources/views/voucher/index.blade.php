        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                        ...
                        <tbody>
                            @foreach ($vouchers as $key => $voucher)
                                <tr>
                                    ...
                                    @if ($voucher->user)
                                    @can('user:read')
                                    <td><a href="{{ route('admin.user.show', $voucher->user->id) }}">{{ $voucher->user->account }}</a></td>
                                    @else
                                    <td>{{ $voucher->user->account }}</td>
                                    @endcan
                                    @else
                                    <td></td>
                                    @endif
                ...
                <div class="table-footer mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ $vouchers->appends($_GET)->links(get_admin_theme_extend($admin_active_theme, 'paginate')) }}
                        </div>
                    </div>
                </div>
            </div>
