...
class SaleProductController extends Controller
{
    ...
    {
        try {
            $this->authorize('sale_product:browse');
            ...
            ->with('danger', __('notification.permission.fail', ['action' => 'browse sale product']));
        }
    }
    ...
    {
        try {
            $this->authorize('sale_product:add');
            ...
            ->with('danger', __('notification.permission.fail', ['action' => 'add sale product']));
        }
    }
    ...
    {
        try {
            $this->authorize('sale_product:edit');
            ...
            return redirect()
            ->route('admin.sale.product.index', $sale_id)
            ->with('danger', __('notification.permission.fail', ['action' => 'edit sale product']));
        }
    }
    ...
    {
        try {
            $this->authorize('sale_product:delete');
            ...
            return redirect()
            ->route('admin.sale.product.index', $sale_id)
            ->with('danger', __('notification.permission.fail', ['action' => 'delete sale product']));
        }
    }
}
