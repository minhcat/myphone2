        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                        ...
                        <tbody>
                            @foreach ($sales as $key => $sale)
                                <tr>
                                    ...
                                    @if ($sale->user)
                                    @can('user:read')
                                    <td><a href="{{ route('admin.user.show', $sale->user->id) }}">{{ $sale->user->account }}</a></td>
                                    @else
                                    <td>{{ $sale->user->account }}</td>
                                    @endcan
                                    @else
                                    <td></td>
                                    @endif
                ...
                <div class="table-footer mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ $sales->appends($_GET)->links(get_admin_theme_extend($admin_active_theme, 'paginate')) }}
                        </div>
                    </div>
                </div>
            </div>
