...
@section('small-info')
<small>Transporter Detail</small>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            ...
            <div class="box-body text-4">
                ...
                <div class="field-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            @if ($transporter->user)
                            <p>{{ $transporter->user->fullname }} ({{ $transporter->user->account }})</p>
                            @endif
                        </div>
                    </div>
                </div>
                <div class="field-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <p>{{ $transporter->created_at?->format('H:i:s d/m/Y') }}</p>
                        </div>
                    </div>
                </div>
                <div class="field-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <p>{{ $transporter->updated_at?->format('H:i:s d/m/Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="box-footer">
                ...
                <a href="{{ route('admin.transporter.edit', $transporter->id) }}" class="btn btn-primary">Edit</a>
                @endcan
            </div>
        </div>
    </div>
