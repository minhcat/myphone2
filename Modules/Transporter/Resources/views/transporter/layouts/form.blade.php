                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="name" type="text" class="form-control input-required" name="name" value="{{ old('name', $transporter->name) }}" autocomplete="name">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="description" class="form-control" rows="4" name="description">{{ old('description', $transporter->description) }}</textarea>
                            </div>
                        </div>
                    </div>
