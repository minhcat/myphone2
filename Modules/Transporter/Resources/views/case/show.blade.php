...
@section('small-info')
<small>Transporter Case Detail</small>
@endsection
            ...
            <div class="box-body text-4">
                ...
                <div class="field-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <p>{{ $transporter_case->description }}</p>
                        </div>
                    </div>
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <p>{{ $transporter_case->created_at?->format('H:i:s d/m/Y') }}</p>
                        </div>
                    </div>
                </div>
                <div class="field-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <p>{{ $transporter_case->updated_at?->format('H:i:s d/m/Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
