        ...
        <div class="box box-primary box-main">
            ...
            <div class="box-body">
                    ...
                    <table class="table table-bordered table-striped table-fix mt-3">
                        <thead>
                            <tr>
                                ...
                                <th>Created At</th>
                                <th>Updated At</th>
                                @canany(['transporter_case:edit', 'transporter_case:delete'])
                ...
                <div class="table-footer mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ $transporter_cases->appends($_GET)->links(get_admin_theme_extend($admin_active_theme, 'paginate')) }}
                        </div>
                    </div>
                </div>
            </div>
