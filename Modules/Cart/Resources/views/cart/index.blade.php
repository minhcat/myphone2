        ...
        <div class="box box-primary box-main">
            ...
            <div class="box-body">
                        ...
                        <tbody class="tbody-data hidden">
                            @foreach ($carts as $key => $cart)
                                <tr>
                                    ...
                                    @if ($cart->user)
                                    @can('user:read')
                                    <td><a href="{{ route('admin.user.show', $cart->user->id) }}">{{ $cart->user->account }}</a></td>
                                    @else
                                    <td>{{ $cart->user->account }}</td>
                                    @endcan
                                    @else
                                    <td></td>
                                    @endif
                ...
                <div class="table-footer mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ $carts->appends($_GET)->links(get_admin_theme_extend($admin_active_theme, 'paginate')) }}
                        </div>
                    </div>
                </div>
            </div>
