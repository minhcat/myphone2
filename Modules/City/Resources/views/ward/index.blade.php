        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                        ...
                        <tbody>
                            @foreach ($wards as $key => $ward)
                                <tr>
                                    ...
                                    @if ($ward->user)
                                    @can('user:read')
                                    <td><a href="{{ route('admin.user.show', $ward->user->id) }}">{{ $ward->user->account }}</a></td>
                                    @else
                                    <td>{{ $ward->user->account }}</td>
                                    @endcan
                                    @else
                                    <td></td>
                                    @endif
                ...
                <div class="table-footer mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ $wards->appends($_GET)->links(get_admin_theme_extend($admin_active_theme, 'paginate')) }}
                        </div>
                    </div>
                </div>
            </div>
