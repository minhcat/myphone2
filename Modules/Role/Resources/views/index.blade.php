        ...
        <div class="box box-primary box-main">
            ...
            <div class="box-body">
                        ...
                        <tbody class="tbody-data hidden">
                            @foreach ($roles as $key => $role)
                                <tr>
                                    ...
                                    @if ($role->user)
                                    @can('user:read')
                                    <td><a href="{{ route('admin.user.show', $role->user->id) }}">{{ $role->user->account }}</a></td>
                                    @else
                                    <td>{{ $role->user->account }}</td>
                                    @endcan
                                    @else
                                    <td></td>
                                    @endif
                ...
                <div class="table-footer mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ $roles->appends($_GET)->links(get_admin_theme_extend($admin_active_theme, 'paginate')) }}
                        </div>
                    </div>
                </div>
            </div>
