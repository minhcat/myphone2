        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                        ...
                        <tbody>
                            @foreach($brands as $key => $brand)                                
                                <tr>
                                    ...
                                    @if ($brand->user)
                                    @can('user:read')
                                    <td><a href="{{ route('admin.user.show', $brand->user->id) }}">{{ $brand->user->account }}</a></td>
                                    @else
                                    <td>{{ $brand->user->account }}</td>
                                    @endcan
                                    @else
                                    <td></td>
                                    @endif
                ...
                <div class="table-footer mt-3">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ $brands->appends($_GET)->links(get_admin_theme_extend($admin_active_theme, 'paginate')) }}
                        </div>
                    </div>
                </div>
            </div>
