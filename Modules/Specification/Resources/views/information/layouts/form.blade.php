@php
    $information = isset($information) ? $information : new Modules\Specification\Entities\Information;
@endphp
<div class="row">
    <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-required" name="value" value="{{ old('value', $information->value) }}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" name="description">{{ old('description', $information->description) }}</textarea>
                            </div>
                        </div>
                    </div>
