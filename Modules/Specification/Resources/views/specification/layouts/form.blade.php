@php
    $specification = isset($specification) ? $specification : new Modules\Specification\Entities\Specification;
@endphp
<div class="row">
    <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-required" name="name" value="{{ old('name', $specification->name) }}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" name="description">{{ old('description', $specification->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="note" value="{{ old('note', $specification->note) }}">
                            </div>
                        </div>
                    </div>
