...
@section('small-info')
<small>Transport Fee Detail</small>
@endsection
        ...
        <div class="box box-primary">
            ...
            <div class="box-body text-4">
                ...
                <div class="field-group">
                    <div class="row">
                        <div class="col-lg-2">
                            <p><strong>Transporter Case</strong></p>
                        </div>
                        <div class="col-lg-10">
                            <p>{{ $transport_fee->case->name }}</p>
                        </div>
                    </div>
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <p>{{ $transport_fee->created_at?->format('H:i:s d/m/Y') }}</p>
                        </div>
                    </div>
                </div>
                <div class="field-group">
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <p>{{ $transport_fee->updated_at?->format('H:i:s d/m/Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
